  ...
  return (
    <div className="p-10 bg-[#F4F4F4] w-fit flex flex-col items-center gap-10 m-auto mt-24 shadow">
          ...
          <div className="flex justify-center py-4 gap-3">
            ...
            {cropData && (
              <button
                ...
                className="text-white py-3 px-5 bg-green-600 rounded-xl font-semibold"
              >
                {loading ? <FadeLoader color="white" /> : "Save Image"}
              </button>
            )}
          </div>
          {cropData && (
      ...
      <div className="w-24 h-24 relative rounded-full overflow-hidden group">
        ...
        <label
          htmlFor="img"
          className="w-full h-full scale-0 group-hover:scale-100 transition-all cursor-pointer absolute top-0 left-0 bg-[rgba(0,0,0,0.5)] flex items-center justify-center"
        >
